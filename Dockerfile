...
RUN sudo yum -y update && sudo yum -y install python3 python3-dev python3-pip python3-virtualenv \
...
RUN cd /home/ec2-user && sudo wget https://apache.osuosl.org/spark/spark-2.4.5/spark-2.4.5-bin-hadoop2.7.tgz && tar -xzf spark-2.4.5-bin-hadoop2.7.tgz && rm spark-2.4.5-bin-hadoop2.7.tgz
